...
*/
function clicked(){
    console.log("Han clickeado");
}
function presentaDatos("ejajax.html"){
            console.log("success");
            $("#resultados").html(ejajax.html);
function.peticionGet(){
    $("#getAjax").click(doGet);
        presentaDatos)
        console.log("otro éxito")
});
    
function init(){
    console.log("DOM Cargado Jquery");
    $("#getAjax").click(clicked);
    $("clicked").get"titulo.html"
    }
$(document).ready(init);
